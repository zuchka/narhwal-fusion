            ...
            <CardContent className="pt-0 pb-6">
              ...
              <div className="h-[250px] w-full">
                <svg className="w-full h-full" viewBox="0 0 1000 210">
                  ...
                  <path
                    d="M 0,180 C 36,165 107,170 143,155 C 179,140 214,125 286,105 C 322,95 357,90 429,75 C 465,65 500,55 571,40 C 607,30 643,25 714,15 C 750,10 786,8 857,5 C 893,3 929,8 1000,12 L 1000,210 L 0,210 Z"
                  ...
                  {/* Red line - stroke */}
                  <path
                    d="M 0,180 C 36,165 107,170 143,155 C 179,140 214,125 286,105 C 322,95 357,90 429,75 C 465,65 500,55 571,40 C 607,30 643,25 714,15 C 750,10 786,8 857,5 C 893,3 929,8 1000,12"
                    fill="none"
                    stroke="#d93535"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                  ...
                  <path
                    d="M 0,185 C 36,172 107,175 143,162 C 179,148 214,132 286,115 C 322,105 357,98 429,85 C 465,75 500,65 571,52 C 607,43 643,38 714,28 C 750,22 786,18 857,15 C 893,12 929,16 1000,20 L 1000,210 L 0,210 Z"
                  ...
                  {/* Dark line - stroke */}
                  <path
                    d="M 0,185 C 36,172 107,175 143,162 C 179,148 214,132 286,115 C 322,105 357,98 429,85 C 465,75 500,65 571,52 C 607,43 643,38 714,28 C 750,22 786,18 857,15 C 893,12 929,16 1000,20"
                    fill="none"
                    stroke="#282d35"
                    strokeWidth="2.5"
                    strokeLinecap="round"
